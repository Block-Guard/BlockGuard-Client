...
const NotLoginedUserInfoSection = () => {
  ...
  return (
    <div className="flex flex-col gap-9.5 px-7 pb-5.5 border-b-8 border-b-monochrome-100">
      <div className="flex flex-row items-center justify-between">
        ...
        <img className="w-25 pr-1" src={BlockeeProfile} />
      </div>
      <div className="flex flex-col gap-[15px] items-center px-5.5">
