    ...
    <div className="flex flex-col w-full h-full">
      <Header
        leftChild={
          <button onClick={handleBackClick}>
            <svg className="text-white" width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="h-37 flex justify-between items-end mt-[57px] pt-6 pl-6 pr-9 overflow-clip bg-[#FFCD42]">
        <div className="h-full flex items-start">
          <div className="max-w-60 h-18 bg-[#D9AE38] rounded-[50px] px-4
        ...
        <div className="h-full flex items-end">
          <img src={BlockeeWarning} alt="캐릭터" className="relative top-4" style={{ width: '120px', height: '96px', objectFit: 'cover' }} />
        </div>
      </div>
