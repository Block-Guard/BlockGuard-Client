        ...
        <div className="h-[800px] overflow-y-scroll no-scrollbar">
            <div className="w-full h-[718px] relative p-6 bg-blue-500 rounded-bl-[20px] rounded-br-[20px] ">
                ...
                <div className="flex flex-col items-center">
                    <div className="flex flex-col justify-between w-[344px] h-52 relative mt-39 mb-4 p-4
                 bg-white rounded-[20px] not-last-of-type:outline-2 outline-offset-[-2px] outline-white/60 backdrop-blur-sm">
                        ...
                        <div>
                            ...
                            <button className="w-[310px] h-11 py-1.5 z-10
                    ...
                    <div className="w-[344px] h-28 p-4
            ...
            <div className="justify-center text-slate-950 text-xl font-bold font-['Pretendard'] leading-loose">바로 신고 및 대응</div>
