...
const VoiceChats = [
  <div className="w-full p-2.5 bg-white/75 rounded-[20px] outline-2 outline-offset-[-2px] outline-white/60 inline-flex flex-col justify-start items-center gap-2.5 font-medium">
  ...
  <div className="w-full p-2.5 bg-white/75 rounded-[20px] outline-2 outline-offset-[-2px] outline-white/60 inline-flex flex-col justify-start items-center gap-2.5 font-medium">
    ...
    고객님 대출 가능여부 확인되셨고요,
    <br />
    현재 고객님은 정부협약 특별 우대상품 대상자라서 신청이 가능하십니다.
    <br />
...
const VoiceChatRenderer = () => {
  ...
  return (
    <div
      className="h-[50%] flex flex-col justify-start items-start gap-2.5 mb-25"
