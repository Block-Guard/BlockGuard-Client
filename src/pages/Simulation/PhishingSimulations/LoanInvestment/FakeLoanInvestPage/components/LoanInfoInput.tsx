...
export const LoanInfoInput = ({ label, placeholder, inputState, inputStateSetter, isReminded }: LoanInfoInputProps) => {
    ...
    return (
        <div className="flex flex-col">
            ...
            <input type="text"
                ...
                ${(info === "") && isReminded ? "outline-red-600":"outline-gray-100"}
