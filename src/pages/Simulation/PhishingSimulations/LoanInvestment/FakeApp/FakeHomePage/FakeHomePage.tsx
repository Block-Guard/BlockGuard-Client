...
const FakeHomePage = () => {
    ...
    return (
        <div>
            ...
            <div className="w-full h-2 bg-sky-700 mt-[87px] mb-10" />

            <div className="fixed top-16 z-0 -right-1 flex justify-center items-end origin-top-left rotate-[9.45deg] rounded-[6px] w-28 h-17 bg-sky-700 py-1">
            ...
            <div className="flex gap-2 px-5.5">
                <div className=" text-sky-700 text-5xl font-bold leading-[67.50px]">
                    i-ONE
                </div>
                <img src={FakeLoanImg} />
            </div>

            <div className="justify-start px-5.5 mb-9">
                <span className="text-green-600 text-2xl font-semibold leading-10">
                    i-ONE 뱅크 업으로 쉽고 빠르게!<br />
                </span>
            ...
            <div className="flex justify-center w-full h-20 bg-sky-700 py-3.5 px-15.5 gap-3">
