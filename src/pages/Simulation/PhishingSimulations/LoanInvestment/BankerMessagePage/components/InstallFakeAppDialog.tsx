...
import FakeAppLogo from "../../../../../../assets/simulation/loan-investment/fake-bank-app-icon.png";
...
export const InstallFakeAppDialog = ({
  isOpen,
  setIsOpen,
}: InstallFakeAppDialogProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent
        className="w-[90%] p-5 h-36 bg-[#E9E9EB]"
        showCloseButton={false}
      >
        <div className="flex items-center gap-10">
          <img className="w-[68px]" src={FakeAppLogo} alt="가짜 로고" />
        ...
        <DialogFooter>
          {progress === 0 ? (
            <div className="flex justify-around">
              <div
                className="text-right justify-start text-sky-500 text-base font-semibold leading-none"
                onClick={() => setIsOpen(false)}
              >
                취소
              </div>
              <div
                className="text-right justify-start text-sky-500 text-base font-semibold leading-none relative"
